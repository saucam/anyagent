...
- **Windsurf adapter** — skills map to native `.windsurf/workflows/*.md` (invoke with `/name`), agents become manually-triggered `.windsurf/rules/*.md`, and `CLAUDE.md` becomes an `always_on` workspace rule. Lossy spots (no skill folder, no subagent concept) are reported, not dropped.
...
[Unreleased]: https://github.com/saucam/anyagent/compare/v0.3.0...HEAD
[0.3.0]: https://github.com/saucam/anyagent/compare/v0.2.1...v0.3.0
